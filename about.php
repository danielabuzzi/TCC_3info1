...
<section class="breadcrumbs-custom bg-image novi-background bg-primary">
          ...
          <div class="row row-30 justify-content-xl-between">
            <div class="col-md-6 col-xl-6">
              ...
              <div class="box-shadow-2">
                ...
                </div><img class="img-responsive" src="<?php echo base_url('images/about-1-569x338.jpg');?>" alt="" width="569" height="169"/>
              </div>
            </div>
      ...
      <section class="section section-lg bg-gray-800">
        <div class="container text-center text-xl-left">
          ...
          <div class="owl-carousel owl-carousel-4 text-center" data-items="1" data-sm-items="3" data-md-items="4" data-lg-items="5" data-xl-items="6" data-dots="true" data-nav="false" data-stage-padding="15" data-loop="false" data-margin="30" data-mouse-drag="false">
            <div class="item"><a class="link-image" href="#"><img src="<?php echo base_url('images/brand-light-1-133x6');?>5.png" alt="" width="133" height="32"/></a></div>
            <div class="item"><a class="link-image" href="#"><img src="<?php echo base_url('images/brand-light-2-117x6');?>1.png" alt="" width="117" height="30"/></a></div>
            <div class="item"><a class="link-image" href="#"><img src="<?php echo base_url('images/brand-light-3-147x7');?>0.png" alt="" width="147" height="35"/></a></div>
            <div class="item"><a class="link-image" href="#"><img src="<?php echo base_url('images/brand-light-4-139x6');?>4.png" alt="" width="139" height="32"/></a></div>
            <div class="item"><a class="link-image" href="#"><img src="<?php echo base_url('images/brand-light-5-123x6');?>7.png" alt="" width="123" height="33"/></a></div>
            <div class="item"><a class="link-image" href="#"><img src="<?php echo base_url('images/brand-light-6-151x7');?>2.png" alt="" width="151" height="36"/></a></div>
          </div>
        </div>
      </section>
      <!-- Our Team-->
        ...
        <div class="container text-center text-lg-left">
          ...
          <div class="row row-40">
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="<?php echo base_url('images/testimonials-1-138x');?>138.jpg" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
            ...
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="<?php echo base_url('images/testimonials-2-138x');?>138.jpg" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
            ...
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="<?php echo base_url('images/testimonials-3-138x');?>138.jpg" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
      ...
      </section><a class="banner" href="https://www.templatemonster.com/website-templates/monstroid2.html" target="_blank"><img src="<?php echo base_url('images/monstroid-big.jpg" ');?>alt="" height="0"></a>
            ...
            <div class="row row-40">
              ...
              <div class="col-md-12 col-lg-4">
                ...
                <div class="row row-30 align-items-center text-center">
                  <div class="col-6 col-md-4 col-lg-6"><a class="link-image" href="#"><img src="<?php echo base_url('images/footer-1-brand-1-14');?>4x70.png" alt="" width="144" height="35"/></a></div>
                  <div class="col-6 col-md-4 col-lg-6"><a class="link-image" href="#"><img src="<?php echo base_url('images/footer-1-brand-2-12');?>1x68.png" alt="" width="121" height="34"/></a></div>
                  <div class="col-6 col-md-4 col-lg-6"><a class="link-image" href="#"><img src="<?php echo base_url('images/footer-1-brand-3-12');?>1x33.png" alt="" width="121" height="16"/></a></div>
                  <div class="col-6 col-md-4 col-lg-6"><a class="link-image" href="#"><img src="<?php echo base_url('images/footer-1-brand-4-10');?>1x76.png" alt="" width="101" height="38"/></a></div>
                  <div class="col-6 col-md-4 col-lg-6"><a class="link-image" href="#"><img src="<?php echo base_url('images/footer-1-brand-5-10');?>7x53.png" alt="" width="107" height="26"/></a></div>
                  <div class="col-6 col-md-4 col-lg-6"><a class="link-image" href="#"><img src="<?php echo base_url('images/footer-1-brand-6-97');?>x52.png" alt="" width="97" height="26"/></a></div>
                </div>
              </div>
            </div>
          </div>
